...
public class Unit_CreateCustomerPage {
    ...
    private static final String URL_CREATE_PAGE = "http://testsite.local/testsite_resources/postPage/create.php";
    private static final String URL_INDEX_PAGE = "http://testsite.local/testsite_resources/postPage/index.php";
