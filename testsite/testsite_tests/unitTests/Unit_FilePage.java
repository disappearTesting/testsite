...
public class Unit_FilePage {
    ...
    private static final String URL_FILE_PAGE = "http://testsite.local/testsite_resources/filePage/index.php";
    private static final String UPLOAD_FILENAME = "fileToUpload.txt";
    private static final String UPLOAD_PATH = "C:\\Users\\Makarov_K\\IdeaProjects\\testsite\\testsite_resources\\filePage\\folderToUpload\\";
    private static final String UPLOAD_SCRIPT_PATH = "C:\\Users\\Makarov_K\\IdeaProjects\\testsite\\testsite_resources\\filePage\\uploadFile_Success.exe";
    private static final String DOWNLOAD_FILENAME = "fileToDownload.txt";
    private static final String DOWNLOAD_PATH = "C:\\Users\\hookie\\IdeaProjects\\testsite\\testsite_resources\\filePage\\test\\";
