...
public class Notification_Params {
    ...
    private final String method = "submit?dpr=1?";

    private String getParams() {
        String params = method.concat(fb_dtsg).concat(app_id).concat(redirect_url).concat(fallback_redirect_uri)
